...
int main(int argc, char** argv) {
  ...
  auto sub1 = node->create_subscription<DataT>("sensor1", /* history_depth */ 5, process_callback);
  auto sub2 = node->create_subscription<DataT>("sensor2", /* history_depth */ 5, process_callback);
